...
const BUILD_CARDS = [
	...
	{
		"id": "neutral_uncertain_lunge",
		"name": "Affondo Incerto",
		"type": CardRules.TYPE_BUILD,
		"class_id": CardRules.CLASS_NEUTRAL,
		"rarity": CardRules.RARITY_COMMON,
		"cost": 1,
		"effect_text": "Infliggi 4 danni.",
		"effects": {"damage": 4, "damage_per_level": 1},
	},
	{
		"id": "neutral_low_cut",
		"name": "Taglio Basso",
		...
		"rarity": CardRules.RARITY_COMMON,
		"cost": 1,
		"effect_text": "Infliggi 3 danni. Il prossimo intento offensivo del nemico infligge -1 danno.",
		"effects": {"damage": 3, "damage_per_level": 1, "weaken_next_intent": 1},
	},
	{
		"id": "neutral_heavy_swing",
		"name": "Colpo Pesante",
		"type": CardRules.TYPE_BUILD,
		"class_id": CardRules.CLASS_NEUTRAL,
		"rarity": CardRules.RARITY_COMMON,
	...
	{
		"id": "neutral_shield_bash",
		"name": "Scudo in Faccia",
		"type": CardRules.TYPE_BUILD,
		"class_id": CardRules.CLASS_NEUTRAL,
		"rarity": CardRules.RARITY_COMMON,
		"cost": 1,
		"effect_text": "Infliggi 2 danni e ottieni 2 guardia.",
		"effects": {"damage": 2, "damage_per_level": 1, "guard": 2, "guard_per_level": 1},
	},
	{
